...
function About() {
  ...
  return (
    <div id='about' ref={ref} className='about flex flex-col items-center justify-center gap-[80px] mx-[170px] my-[80px]'>
      ...
      <div className="about-sections flex gap-[80px]">
        ...
        <div className="about-right flex flex-col gap-[80px]">
          <div className="about-para flex flex-col gap-[20px] text-[26px] font-normal">
          ...
          <div className="about-skills flex flex-col gap-[20px]">
            <div className="about-skill flex gap-[50px] items-center transition-transform duration-300 hover:scale-[1.05]">
      ...
      <div className="about-achievements flex w-full justify-around mb-[80px]">
        <div className="about-achievement flex flex-col items-center gap-[10px] transition-transform duration-500 hover:scale-[1.12]">
          <h1 className="text-[60px] font-bold bg-gradient-to-r from-[#df8908] to-[#b415ff] bg-clip-text text-transparent">
          {inView ? <CountUp start={0} end={10} duration={5}/> : null}+
          </h1>
          <p className="text-[22px] font-medium uppercase text-center">Years of experience</p>
        </div>
        ...
        <div className="about-achievement flex flex-col items-center gap-[10px] transition-transform duration-500 hover:scale-[1.12]">
          ...
          <p className="text-[22px] font-medium uppercase text-center">Projects completed</p>
        </div>
        <hr className="w-px h-[80px] bg-gray-300" />
        <div className="about-achievement flex flex-col items-center gap-[10px] transition-transform duration-500 hover:scale-[1.12]">
          <h1 className="text-[60px] font-bold bg-gradient-to-r from-[#df8908] to-[#b415ff] bg-clip-text text-transparent">
          ...
          <p className="text-[22px] font-medium uppercase text-center">Happy clients</p>
        </div>
      </div>
    </div>
  )
