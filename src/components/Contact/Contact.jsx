...
function Contact() {
  ...
  return (
    <div id='contact' className="flex flex-col items-center justify-center gap-[80px] mx-[170px] my-[80px]">
      ...
      <div className="flex gap-[150px]">
        ...
        <form onSubmit={onSubmit} className="flex flex-col items-start gap-[30px]">
          ...
          <button type='submit' className="border-none text-white rounded-full bg-gradient-to-r from-[#df8908] to-[#b415ff] text-[22px] py-[20px] px-[60px] mb-[50px] cursor-pointer capitalize transition-transform duration-300 hover:scale-[1.1]">
            submit now
          </button>
        </form>
      </div>
