...
function Services() {
  return (
    <div id='services' className="services flex flex-col items-center justify-center gap-[80px] mx-[170px] my-[80px]">
      ...
      <div className="services-container grid grid-cols-3 gap-[40px] mb-[80px]">
        {services_data.map((service, index) => {
          return (
            <div
              key={index}
              className="services-format flex flex-col justify-center gap-[20px] px-[30px] py-[60px] rounded-[10px] border-2 border-white transition-all duration-400 cursor-pointer hover:border-[#ff00ff] hover:bg-gradient-to-br from-[#3f0028] to-[#582300] transform hover:scale-[1.05]"
            >
